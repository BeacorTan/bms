...
public class SystemConfigController
{
	...
	{
		return new ModelAndView("config/system_config");
	}
    ...
    public ResponseJson del(@RequestBody List<String> idList) {
	 ...
	 public ModelAndView sysConfigEdit(String id, ModelMap modelMap) {
	        if (StringUtils.isNotBlank(id)) {
	            ...
	            return new ModelAndView("config/system_config_profile", modelMap);
	        }
	        return new ModelAndView("config/system_config_profile");
	    }
