...
// */
//@Component
//public class SchedulerUtil extends HelpUtils {
//
...
//
//	private static final String JOB_GROUP_NAME = "Admin_JOBGROUP_NAME";
//
//	private static final String TRIGGER_GROUP_NAME = "Admin_TRIGGERGROUP_NAME";
//
//
//	/**
...
//			jobDetail.getJobDataMap().putAll(isEmpty(jobDataMap) ? new JobDataMap() : jobDataMap);
