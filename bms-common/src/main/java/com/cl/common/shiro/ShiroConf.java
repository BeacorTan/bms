...
public class ShiroConf {
    ...
    public SystemSessionDAO sessionDAO() {
        SystemSessionDAO systemSessionDAO = new SystemSessionDAO();
        systemSessionDAO.setActiveSessionsCacheName("shiro-activeSessionCache");
